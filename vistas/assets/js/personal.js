...
var urlpeticion=document.getElementById("formper").getAttribute("action")
...
function caracteresCorreoValido(){
    var errorcorreo=document.getElementById("percorreo-error");
    var texto=document.getElementById("percorreo").value;
    
    //var email = $(email).val();
    var regex = /^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$/i;
  
    if (!regex.test(texto)) {
        document.getElementById("percorreo-error").innerHTML = "Correo invalido";
    } else {
      document.getElementById("percorreo-error").innerHTML = "";
    }
...
function cancelar(){
    ...
    tieneresponsable=1;
    $('#modal-rgpersonal').modal('hide');

    $('#cuerpo').css('padding-right','0px')


    document.getElementById("formper").reset();
    document.getElementById("perdui").disabled=true;
    ...
    */document.getElementById("pernombre-error").style.display="none";
    document.getElementById("perapellido-error").style.display="none";
    document.getElementById("persexo-error").style.display="none";
    document.getElementById("perfecha-error").style.display="none";
   ...
   */ document.getElementById("alerta").style.visibility="hidden";
    ...
    document.getElementById('perscrool').scrollTop = 0;
...
function nuevoregistro(){
    ...
    document.getElementById("texto").innerHTML="<i class='fa fa-user'></i> Nuevo Empleado";
    document.getElementById("pernombre").style.borderColor="";
    document.getElementById("perapellido").style.borderColor="";
    document.getElementById("persexo").style.borderColor="";
    document.getElementById("perfecha").style.borderColor="";
...
function ExtraerDatosMod(idpersonal){
    document.getElementById("btneditar").style.display="block";
    document.getElementById("btnguardar").style.display="none";
    document.getElementById("texto").innerHTML="<i class='fa fa-edit'></i> Modificar Empleado";
    document.getElementById("pernombre").style.borderColor="";
    document.getElementById("perapellido").style.borderColor="";
    document.getElementById("persexo").style.borderColor="";
    document.getElementById("perfecha").style.borderColor="";
    ...
    */document.getElementById("formper").reset();
    ...
    $.ajax({
        method: "POST",
        url: urlpeticion,
        data: { idpersonal : idpersonal ,accion : "obtenerdatos"  }
      })
        .done(function( msg ) {

        document.getElementById("perid").value=idpersonal;
          
          var datos=JSON.parse(msg);

          var formatfecha=datos.pacfecha.substr(8,2,3)+"/"+datos.pacfecha.substr(5,2,3)+"/"+datos.pacfecha.substr(0,4);

         document.getElementById("pernombre").value=datos.pernombre;
         document.getElementById("perapellido").value=datos.perapellido;
        
         document.getElementById("perfecha").value=formatfecha;
         if(datos.persexo=="FEMENINO"){
            document.getElementById("persexo")[2].selected=true;
          
         }
         if(datos.persexo=="MASCULINO"){
            document.getElementById("persexo")[1].selected=true;
         }
         expedientemod=datos.expediente;
         document.getElementById("perdui").value=datos.perdui;
         document.getElementById("percorreo").value=datos.percorreo;
         document.getElementById("perdireccion").value=datos.perdireccion;
         document.getElementById("pertelefono").value=datos.pertelefono;
         document.getElementById("percargo").value=datos.percargo;

        /* var anio=document.getElementById("actual").value;
                var peranio=datos.perfecha.substr(0,4);
